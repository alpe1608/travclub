...
<?php elseif ($_SERVER['REQUEST_URI'] === '/travclub/web/en'):?>transparent_home_page
<?php elseif ($_SERVER['REQUEST_URI'] === '/travclub/web/ka'):?>transparent_home_page
<?php elseif ($_SERVER['REQUEST_URI'] === '/travclub/web/ru'):?>transparent_home_page
...
<?php elseif ($_SERVER['REQUEST_URI'] === '/travclub/web/en/post/contact'): ?>archive
<?php elseif ($_SERVER['REQUEST_URI'] === '/travclub/web/ka/post/contact'): ?>archive
<?php elseif ($_SERVER['REQUEST_URI'] === '/travclub/web/ru/post/contact'): ?>archive
                ...
                <div class="row">
                        ...
                        <aside id="text-15" class="widget_text">
                            <div class="textwidget">
                                <ul class="top_bar_info clearfix">
                                    <li><i class="fa fa-clock-o"></i> <?= Yii::t('common', 'Mon') ?> - <?= Yii::t('common', 'Sat') ?> 9.00 - 20.00. <?= Yii::t('common', 'Sunday close') ?></li>
                                </ul>
                            </div>
                        </aside>
                    </div>
                    <div class="col-sm-8 topbar-right">
                        <aside id="text-7" class="widget widget_text">
                            <div class="textwidget">
                                <ul class="top_bar_info clearfix">
                                    ...
                                    <li><a href="#" onclick="return getCart()"><i class="fa fa-shopping-cart"></i> <?= Yii::t('common', 'cart') ?></a></li>
                                </ul>
                            </div>
                        </aside>
                        <aside id="travel_login_register_from-2" class="widget widget_login_form">
                            ...
                            <?php endif;?>
                            <span class="show_from login"><a href="<?= Url::to('/travclub/web/admin')?>"><i class="fa fa-user"></i><?= Yii::t('common', 'Log In') ?></a></span>

                            <div class="form_popup from_login" tabindex="-1">
                                <div class="inner-form">
                                    <div class="closeicon"></div>
                                    <h3><?= Yii::t('common', 'Log In') ?></h3>
                            ...
                            <span class="register_btn"><?= Yii::t('common', 'Sign Up') ?></span>
                            <div class="form_popup from_register" tabindex="-1">
                                <div class="inner-form">
                                    <div class="closeicon"></div>
                                    <h3><?= Yii::t('common', 'Sign Up') ?></h3>
                        ...
                        <aside id="text-7" class="widget widget_text">
                            <div class="textwidget">
                                <?= Html::a('GEO', ['', 'language' => 'ka']) ?> |
                                <?= Html::a('RUS', ['', 'language' => 'ru']) ?> |
                                <?= Html::a('ENG', ['', 'language' => 'en']) ?>
                            </div>
                        </aside>
                    </div>
                </div>
        ...
        <div class="navigation-menu">
            <div class="container">
                ...
                <div class="width-logo sm-logo">
                    <?php if($_SERVER['REQUEST_URI'] === '/travclub/web/ru'):?>
                    <a href="/travclub/web/category/index" title="Travelers club" rel="home">
                        ...
                        <?php elseif ($_SERVER['REQUEST_URI'] === '/travclub/web/ka'):?>
                            <a href="/travclub/web/category/index" title="Travelers club" rel="home">
                                <?= Html::img('@web/images/logo.png', ['alt' => 'Travelers club',  'class' => 'logo_transparent_static', 'width' => '474', 'height' => '130'])?>
                                <?= Html::img('@web/images/logo_sticky.png', ['alt' => 'Travelers club',  'class' => 'logo_sticky', 'width' => '474', 'height' => '130'])?>
                            </a>
                            <?php elseif($_SERVER['REQUEST_URI'] === '/travclub/web/en'):?>
                                <a href="/travclub/web/category/index" title="Travelers club" rel="home">
                                    <?= Html::img('@web/images/logo.png', ['alt' => 'Travelers club',  'class' => 'logo_transparent_static', 'width' => '474', 'height' => '130'])?>
                                    <?= Html::img('@web/images/logo_sticky.png', ['alt' => 'Travelers club',  'class' => 'logo_sticky', 'width' => '474', 'height' => '130'])?>
                                </a>
                ...
                <nav class="width-navigation">
                    <ul class="nav navbar-nav menu-main-menu side-nav" id="mobile-demo">
                        <li class="current-menu-ancestor current-menu-parent menu-item-has-children">
                            <a href="/travclub/web/category/index"><?= Yii::t('common', 'Home') ?></a>
                        </li>
                        <li class="menu-item-has-children">
                            <a href="#"><?= Yii::t('common', 'Services') ?> <i class="fa fa-angle-down"></i></a>
                            <ul class="sub-menu">
                                <li><a href="/travclub/web/category/list"><?= Yii::t('common', 'destination') ?> </a>
                                    <!--<ul class="sub-menu">
                                ...
                                <li><a href="#">
                                        <?= Yii::t('common', 'tours') ?> </i></a>
                                    <ul class="sub-menu">
                                        <li><a href="/travclub/web/category/tour-list"><?= Yii::t('common', 'internal tours') ?></a></li>
                                        <li><a href="/travclub/web/category/tour"><?= Yii::t('common', 'external') ?></a></li>
                                    </ul>
                                </li>
                                <li><a href="#"><?= Yii::t('common', 'excursions') ?> </a></li>
                                <li><a href="#"><?= Yii::t('common', 'events') ?> </a></li>
                                <li><a href="/travclub/web/category/46"><?= Yii::t('common', 'resorts') ?> </a></li>
                                <li><a href="/travclub/web/blog/gallery"><?= Yii::t('common', 'gallery') ?></a></li>
                            </ul>
                        </li>

                        <li class="menu-item-has-children">
                            <a href="#"><?= Yii::t('common', 'Reservation') ?>  <i class="fa fa-angle-down"></i></a>
                            <ul class="sub-menu">
                                <li><a href="/travclub/web/blog/gallery"><?= Yii::t('common', 'Hotels') ?> </a></li>
                                <li><a href="typography.html"><?= Yii::t('common', 'Airline tickets') ?></a></li>
                                <li><a href="typography.html"><?= Yii::t('common', 'Train tickets') ?></a></li>
                                <li><a href="typography.html"><?= Yii::t('common', 'Bus tickets') ?></a></li>
                                <li><a href="/travclub/web/booking/checkout"><?= Yii::t('common', 'Checkout') ?></a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children">
                            <a href="#"><?= Yii::t('common', 'Tips') ?> <i class="fa fa-angle-down"></i></a>
                            <ul class="sub-menu">
                                <li><a href="/travclub/web/tips/index"><?= Yii::t('common', 'Tips for travelers') ?></a></li>
                                <li><a href="/travclub/web/tips/view"><?= Yii::t('common', 'Terms and symbols') ?></a></li>
                            </ul>
                        </li>
                        <li><a href="/travclub/web/blog/"><?= Yii::t('common', 'Blog') ?> </a></li>

                        <li><a href="/travclub/web/post/contact"><?= Yii::t('common', 'Contacts') ?> </a></li>
                        <li class="menu-right">
                            <ul>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <aside class="col-sm-3 custom-instagram widget_text">
                        ...
                        <div class="textwidget">
                            <ul>
                                <li><a href="#" data-toggle="tooltip" data-placement="top" data-original-title="Instagram"><img src="/travclub/web/images/social/instagram.png" alt="instagram"></a></li>
                                <li><a href="#" data-toggle="tooltip" data-placement="top" data-original-title="Facebook"><img src="/travclub/web/images/social/facebook.png" alt="facebook"></a></li>
                                <li><a href="#" data-toggle="tooltip" data-placement="top" data-original-title="LinkedIn"><img src="/travclub/web/images/social/linkedin.png" alt="linkedin"></a></li>
                                <li><a href="#" data-toggle="tooltip" data-placement="top" data-original-title="YouTube"><img src="/travclub/web/images/social/youtube.png" alt="youtube"></a></li>
                                <li><a href="#" data-toggle="tooltip" data-placement="top" data-original-title="Twitter"><img src="/travclub/web/images/social/twitter.png" alt="twitter"></a></li>
                                <li><a href="#" data-toggle="tooltip" data-placement="top" data-original-title="Pinterest"><img src="/travclub/web/images/social/pinterest.png" alt="pinterest"></a></li>
                                <li><a href="#" data-toggle="tooltip" data-placement="top" data-original-title="Google+"><img src="/travclub/web/images/social/google-plus.png" alt="google-plus"></a></li>
                                <li><a href="#" data-toggle="tooltip" data-placement="top" data-original-title="Viber"><img src="/travclub/web/images/social/viber.png" alt="viber"></a></li>
                                <li><a href="#" data-toggle="tooltip" data-placement="top" data-original-title="Skype"><img src="/travclub/web/images/social/skype.png" alt="skype"></a></li>
                            </ul>
                        </div>
                    </aside>
                </div>
...
Modal::begin([
    ...
    'id' => 'cart',
    'size' => 'modal-lg',
    'footer' => '<button type="button" class="btn btn-default" data-dismiss="modal">შერჩევის გაგრძელება</button>
                     <a href="' . Url::to(['cart/view']) .'" class="btn btn-success">შეკვეთის გაფორმება/დაჯავშნა</a>
                     <button type="button" class="btn btn-danger" onclick="clearCart()">კალათის გასუფთავება</button>'
]);
